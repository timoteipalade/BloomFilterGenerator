...
//To generate the bloom filter file use the project at https://github.com/timotei-cliqz/BloomFilterGenerator.git
...
//        self.array.console_log()
//        self.console_log()
    }
    
    required public init?(coder aDecoder: NSCoder) {
        self.array = aDecoder.decodeObject(forKey: "internalArray") as? BitArray ?? BitArray(count: 0)
...
//        self.console_log()
    ...
    func console_log() {
        print(self.k)
        print(self.hashFunctions.description)
    }
